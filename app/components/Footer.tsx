...
function SocialLink({
  ...
  return (
    <a
      ...
      aria-label={label}
      className="flex cursor-pointer size-9 items-center justify-center rounded-[9px] bg-white/[0.06] text-white/80 transition-all hover:scale-105 hover:bg-white/[0.12] hover:text-white active:scale-95"
    >
      {children}
    </a>
  );
          ...
          <li key={item.label}>
            {item.external ? (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="ml-[8px] cursor-pointer text-[14px] text-white/60 transition-colors hover:text-white"
              >
                {item.label}
              </a>
            ) : (
        ...
        <div className="flex flex-col gap-12 pt-12 lg:flex-row lg:gap-0 lg:pt-14">
          <div className="lg:w-[34%] lg:shrink-0 lg:pr-10">
            ...
            <div className="mt-8 flex items-center gap-2">
              <SocialLink href="https://x.com/heynakul" label="X (Twitter)">
                <IconX />
              </SocialLink>
              <SocialLink
                href="https://github.com/naaakul/vishlex"
                label="Github"
              >
                <IconGithub />
              </SocialLink>
